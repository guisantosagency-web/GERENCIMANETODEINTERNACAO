...
import { Users, Bed, Activity, MapPin, Baby, Home, Calendar, ArrowLeft } from "lucide-react"
        ...
        <div className="space-y-8 pb-24">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                <div className="space-y-2">
                    <Link href="/internacoes" className="inline-flex items-center gap-2 text-primary hover:gap-3 transition-all font-bold text-sm mb-2 group">
                        <ArrowLeft className="h-4 w-4" />
                        Voltar para Lista
                    </Link>
                    <h1 className="text-5xl lg:text-6xl font-black font-space tracking-tight gradient-text">Dashboard Internações</h1>
                    <p className="text-muted-foreground font-medium text-lg max-w-xl">Inteligência de dados e monitoramento em tempo real.</p>
                </div>
